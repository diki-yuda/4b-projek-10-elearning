...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-success fixed-top">
        <div class="container-fluid">
            <a class="navbar-brand fw-bold fs-3" href="#">Guruku | Admininstrator</a>
    ...
    <div class="row main g-0">
        <div class="col-md-2 bg-secondary">
            ...
            <div class="profile mt-5 pt-3 text-center">
                <img src="../../assets/img/profile.png" class="rounded-circle d-block mx-auto border" alt="Foto" width=70>
